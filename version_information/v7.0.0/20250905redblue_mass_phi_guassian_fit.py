...
import mceh.model.group_redblue_mass_phi_guassian as fitting
import numpy as np
...
mceh.printt('Start')
cpu_num = 8
rs_rd_result = mceh.pickle_load('result/20250812redblue_bkg.pickle')
...
mceh.pickle_dump(all_result, 'result/20250905redblue_mass_phi_guassian_fit.pickle')
