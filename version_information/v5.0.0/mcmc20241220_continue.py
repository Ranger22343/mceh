...
cpu_num = 40
cpu4fit = 32
ut.printt('code name: mcmc20241220_continue.py')
ut.printt(f'cpu: {cpu_num}')
ut.printt('memory: 32G')
ut.printt('Start')
previous_result = ut.pickle_load('result/mcmc20241219.pickle')
...
result = {'sampler': sampler, 'state': state, 'is_used': is_used,
          'mcmc_dict': mcmc_dict}
ut.pickle_dump(result, 'result/mcmc20241220_continue.pickle')
